...
//procedure jpeg_mem_src(cinfo: j_decompress_ptr; inbuffer: PAnsiChar; insize: Cardinal);
...
//procedure jpeg_mem_src(cinfo: j_decompress_ptr; inbuffer: PAnsiChar; insize: Cardinal); external;
